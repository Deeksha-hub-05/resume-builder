...
const Testimonials = () => {
    ...
    return (
        <>
        <div id='testimonials' className='flex flex-col items-center my-10 scrol-mt-12'>
            <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
                <BookUserIcon className="size-4.5 stroke-green-600"/>
                <span>Testimonials</span>
            </div>
            <Title title="Don't just take our words" description="See how others are building their careers with our AI-powered resume builder. If you have a positive experience with us , just leave a review" />
        </div>
